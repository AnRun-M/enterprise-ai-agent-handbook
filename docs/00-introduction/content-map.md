...
| 第 5 章：Tool Registry | 能力描述与执行映射、Definition/Handler 分离、Dispatch 三职责、权限纵深防御、schema 版本、Result Contract | `examples/manual_agent_loop`、`examples/basic_langgraph` | 等价对照 | 实现完成 / 待架构审查 | v0.3.0 |
