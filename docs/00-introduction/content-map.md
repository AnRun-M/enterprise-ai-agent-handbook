...
| 第 3 章：Model Context | 一次调用可见输入、State→Context 切片、Prompt 是 Context 组件、Context Builder 归属 | `examples/manual_agent_loop`、`examples/basic_langgraph` | 等价对照 | draft / 待架构审查 | v0.3.0 |
