...
| 第 2 章：Execution State | 唯一控制事实源、State 生命周期与演化、进入与不进入、Schema 契约 | `examples/manual_agent_loop`、`examples/basic_langgraph` | State reducer、等价对照、failure_reason 三场景 | draft / 待架构审查 | v0.3.0 |
