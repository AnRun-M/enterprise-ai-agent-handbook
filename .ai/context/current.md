...
- Agent Runtime Design Principles（2026-08-01，TASK-0004，分支 feature/design-principles）：
  - docs/99-design-principles/ 六份文档：index（项目宪法定位）/ 01-runtime / 02-state / 03-llm-vs-runtime / 04-testing / 05-review-checklist
  - 全部原则可溯源：第 0 章、两个 Runtime 代码、PR #2 / PR #4 Review、ADR-0003~0006
  - 明确禁止新增理论；Review Checklist 成为此后每个 PR 的必查清单
  - mkdocs 导航、content-map、ROADMAP v0.3.0 里程碑项已更新
  - 待 PR 创建与架构审查，不 Merge
